...
~~~~~~~~~~~~~~~~~~~~
RAG system using ChromaDB for vector storage with hybrid search (Vector + BM25).
...
class ChromaPDFRAG:
    """
    RAG system using ChromaDB for vector storage with BM25 hybrid search.
    """
    ...
    def __init__(
        ...
        print(f"ChromaPDFRAG initialized:")
    ...
    def index_pdf(self, pdf_path: str, reindex: bool = False) -> int:
        ...
        for idx, (chunk, embedding) in enumerate(zip(chunks, embeddings_list)):
            ...
            meta = {
                ...
                # Store lists as JSON strings (Chroma doesn't support list metadata natively)
